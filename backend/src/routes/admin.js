...
router.get("/bookings-summary", protect, admin, (req, res) => {
  res.json({
    totalBookings: 0,
    message: "Bookings module not implemented yet",
  });
});
...
router.get("/feedback-summary", protect, admin, (req, res) => {
  res.json({
    totalFeedbacks: 0,
    message: "Feedback module not implemented yet",
  });
});
...
router.get("/complaints-summary", protect, admin, (req, res) => {
  res.json({
    totalComplaints: 0,
    message: "Complaints module not implemented yet",
  });
});
...
router.get("/promotions-summary", protect, admin, (req, res) => {
  res.json({
    activePromotions: 0,
    message: "Promotions module not implemented yet",
  });
});
