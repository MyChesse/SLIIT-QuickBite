            ...
            <div className="max-w-7xl mx-auto px-8 grid grid-cols-2 md:grid-cols-4 gap-10">
                ...
                <div>
                    ...
                    <div className="space-y-2 text-sm">
                        <Link to="/menu" className="block hover:text-blue-400 transition">Home</Link>
                        <Link to="/orders" className="block hover:text-blue-400 transition">My Orders</Link>
                        <Link to="/menu" className="block hover:text-blue-400 transition">Menu</Link>
                        <Link to="/feedback" className="block hover:text-blue-400 transition">Feedback</Link>
                    </div>
                </div>
