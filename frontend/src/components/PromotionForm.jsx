  ...
  return (
    <>
      ...
      <div className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-[0_30px_70px_-30px_rgba(15,23,42,0.08)]">
        <div className="mb-10">
          <p className="text-xs uppercase tracking-[0.35em] text-primary font-semibold">Promotion Builder</p>
          <h2 className="mt-3 text-3xl font-extrabold text-slate-950">Create a polished promotion</h2>
          <p className="mt-3 max-w-2xl text-sm text-slate-500">Fill in the form below to publish a new offer for {canteenName} without changing the underlying behavior.</p>
          ...
          <div className="mt-6 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <span className={`text-sm font-semibold transition-colors ${
                ...
                {showScheduled ? 'Hide Scheduled' : 'Show Scheduled'} ({scheduledPromotions.length})
              </span>
            </div>
        ...
        <div className="grid gap-8 lg:grid-cols-[2.2fr_1fr]">
          <div className="rounded-[1.75rem] border border-slate-200 bg-slate-50 p-6 shadow-sm">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-3">
                <label className="text-sm font-bold uppercase tracking-[0.2em] text-primary bg-primary/10 px-3 py-1 rounded-lg inline-block">Issuing Campus</label>
                <div className="flex items-center gap-4 rounded-3xl border-2 border-primary/20 bg-gradient-to-br from-primary/5 via-primary/10 to-primary/5 px-6 py-5 shadow-lg shadow-primary/10 relative overflow-hidden">
                  ...
                  <div className="flex-1 relative z-10">
                    <p className="text-lg font-bold text-slate-900">{canteenName}</p>
                    <p className="text-sm font-semibold text-primary uppercase tracking-[0.25em]">Selected Campus Location</p>
                  </div>
              ...
              <div className="grid gap-6 md:grid-cols-2">
                <div className="space-y-2">
                  <label htmlFor="title" className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">Promotion Item</label>
                  <input
                    id="title"
                    type="text"
                    name="title"
                ...
                <div className="space-y-2">
                  <label htmlFor="promotionDate" className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">Promotion Date</label>
                  <input
                    id="promotionDate"
                    type="date"
                    name="promotionDate"
              ...
              <div className="space-y-2">
                <label htmlFor="description" className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">Description</label>
                <textarea
                  id="description"
                  name="description"
              ...
              <div className="grid gap-6 md:grid-cols-2">
                <div className="space-y-2">
                  <label htmlFor="originalPrice" className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">Original Price (LKR)</label>
                  <div className="relative rounded-[1.5rem] border border-slate-200 bg-white shadow-sm focus-within:ring-2 focus-within:ring-primary/20">
                    <span className="pointer-events-none absolute left-5 top-1/2 -translate-y-1/2 text-sm font-semibold text-slate-500">Rs.</span>
                    <input
                      id="originalPrice"
                      type="number"
                      name="originalPrice"
                ...
                <div className="space-y-2">
                  <label htmlFor="discountedPrice" className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">Discounted Price (LKR)</label>
                  <div className="relative rounded-[1.5rem] border border-slate-200 bg-white shadow-sm focus-within:ring-2 focus-within:ring-primary/20">
                    <span className="pointer-events-none absolute left-5 top-1/2 -translate-y-1/2 text-sm font-semibold text-slate-500">Rs.</span>
                    <input
                      id="discountedPrice"
              ...
              <div className="grid gap-6 md:grid-cols-2">
                <div className="space-y-2">
                  <label className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">Availability</label>
                  <div className="flex h-[54px] items-center justify-between rounded-[1.5rem] border border-slate-200 bg-white px-4 shadow-sm">
                    <span className="text-sm font-medium text-slate-700">{formData.isAvailable ? 'Available' : 'Unavailable'}</span>
                    <label className="relative inline-flex cursor-pointer items-center">
                      <input
                        type="checkbox"
                        name="isAvailable"
                ...
                <div className="space-y-2">
                  <label htmlFor="image" className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">Image URL (optional)</label>
                  <input
                    id="image"
                    type="url"
                    name="image"
          ...
          <div className="space-y-6">
            <div className="rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-sm">
              <h3 className="mb-4 text-lg font-bold text-slate-900">Quick Info</h3>
              <div className="space-y-4">
                <div className="rounded-3xl bg-blue-50 p-4">
                  <p className="text-xs font-semibold uppercase tracking-[0.2em] text-blue-700">Canteen</p>
                  <p className="mt-1 text-sm font-semibold text-slate-900">{canteenName}</p>
                </div>
                <div className="rounded-3xl bg-slate-50 p-4">
                  <p className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">Status</p>
                  <p className="mt-1 text-sm font-semibold text-slate-900">{formData.isAvailable ? 'Live / Available' : 'Not Available'}</p>
                </div>
                <div className="rounded-3xl bg-slate-50 p-4">
                  <p className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">Selected Date</p>
                  <p className="mt-1 text-sm font-semibold text-slate-900">{formData.promotionDate || 'No date selected'}</p>
                </div>
              </div>
            </div>

            <div className="rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-sm">
              <h3 className="mb-4 text-lg font-bold text-slate-900">Live Preview</h3>
              <div className="overflow-hidden rounded-[1.75rem] border border-slate-200 bg-slate-50">
                <div className="flex h-44 items-center justify-center bg-slate-200">
                  {formData.image ? (
                    ...
                    <span className="text-sm font-medium text-slate-500">No image preview</span>
                  )}
                </div>
                <div className="space-y-3 p-4">
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-[0.2em] text-blue-600">{canteenName}</p>
                    <h4 className="mt-1 text-lg font-bold text-slate-900">{formData.title || 'Promotion title'}</h4>
                  </div>
                  <p className="line-clamp-3 text-sm text-slate-600">{formData.description || 'Promotion description will appear here.'}</p>
                  <div className="flex items-center gap-3">
                    <span className="text-lg font-extrabold text-blue-700">{formData.discountedPrice ? `Rs. ${formData.discountedPrice}` : 'Rs. 0.00'}</span>
                    <span className="text-sm text-slate-400 line-through">{formData.originalPrice ? `Rs. ${formData.originalPrice}` : 'Rs. 0.00'}</span>
                  </div>
                  <div className="flex items-center justify-between pt-2">
                    <span className="text-xs font-medium text-slate-500">{formData.promotionDate || 'No promotion date'}</span>
                    <span className={`rounded-full px-3 py-1 text-xs font-bold ${formData.isAvailable ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>{formData.isAvailable ? 'Available' : 'Unavailable'}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-[1.75rem] border border-blue-100 bg-blue-50 p-6 shadow-sm">
              ...
              <ul className="space-y-2 text-sm text-slate-700">
                ...
                <li>• Make sure discounted price is lower than original price.</li>
        ...
        {showScheduled && scheduledPromotions.length > 0 && (
          <div className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-[0_30px_70px_-30px_rgba(15,23,42,0.08)]">
            <h3 className="mb-6 text-2xl font-bold text-slate-900">Scheduled Promotions</h3>
            <div className="space-y-4">
              {scheduledPromotions
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className={`rounded-full px-2 py-1 text-xs font-bold ${
                          promotion.isAvailable ? 'bg-secondary/20 text-secondary' : 'bg-red-100 text-red-700'
                        }`}>
                          {promotion.isAvailable ? 'Available' : 'Unavailable'}
                        </span>
                      </div>
                      <h4 className="text-lg font-semibold text-slate-900">{promotion.title}</h4>
                      <p className="text-sm text-slate-600 line-clamp-2">{promotion.description}</p>
                      <div className="mt-2 flex items-center gap-3">
                        <span className="text-lg font-bold text-primary">Rs. {promotion.discountedPrice}</span>
                        <span className="text-sm text-slate-400 line-through">Rs. {promotion.originalPrice}</span>
                        <span className="rounded-full bg-primary/10 px-2 py-1 text-xs font-semibold text-primary">
                          -{Math.round(((promotion.originalPrice - promotion.discountedPrice) / promotion.originalPrice) * 100)}%
                        </span>
                      </div>
                    </div>
