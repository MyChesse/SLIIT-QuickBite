...
const CanteenSelection = () => {
  ...
  const sidebarButtonClass =
    "flex w-full items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium text-slate-600 transition hover:bg-slate-50";
  const sidebarActiveClass =
    "flex w-full items-center gap-3 rounded-xl bg-blue-50 px-4 py-3 text-sm font-semibold text-blue-700";
        ...
        <aside className="w-full border-b border-slate-200 bg-white px-5 py-6 lg:w-[250px] lg:border-b-0 lg:border-r">
          <div className="mb-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-[28px] font-bold leading-none text-blue-900">
                  Admin Portal
                </h2>
        ...
        <main className="flex-1 px-4 py-8 sm:px-6 lg:px-8">
          <div className="mx-auto mb-10 max-w-3xl text-center">
            ...
            <p className="mt-4 text-lg leading-relaxed text-slate-600">
              Welcome back, Administrator. Select a specific location below to
              manage menu offerings, active promotions, and inventory levels for
              the day.
            </p>
          </div>
            ...
            {canteens.map((canteen) => (
              ...
              >
                ...
                <div className="space-y-4 p-6">
                  ...
                  <p className="min-h-[84px] text-lg leading-relaxed text-slate-600">
                    {canteen.description}
                  </p>
