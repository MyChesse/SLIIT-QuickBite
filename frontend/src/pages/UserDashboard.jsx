...
const UserDashboard = () => {
  ...
  const accountSettings = [
    ...
    { key: 'notifications', icon: 'notifications_active', label: 'Notifications', badge: 'On' },
      ...
      <aside className="h-screen w-64 fixed left-0 top-0 bg-slate-50 flex-col py-8 gap-2 z-40 hidden md:flex border-r border-[#d5e3fc]">
        <div className="px-6 mb-8">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-[#0040a1] rounded-xl flex items-center justify-center text-white font-black font-['Manrope']">SB</div>
            <div>
              <h1 className="font-['Manrope'] text-lg font-black text-blue-900 leading-tight">QuickBite</h1>
              <p className="text-[10px] uppercase tracking-widest text-slate-500">Academic Dining</p>
            </div>
          </div>
        </div>
      ...
      <main className="md:ml-64 min-h-screen pb-32 md:pb-12 bg-[#f8f9ff]">
        <header className="bg-gradient-to-r from-[#0040a1] via-[#0056d2] to-[#a93802] sticky top-0 z-30 px-6 py-4 flex justify-between items-center max-w-7xl mx-auto shadow-lg shadow-[#0040a1]/20 md:rounded-b-2xl">
          <div className="flex items-center gap-4">
            <h2 className="font-['Manrope'] text-2xl font-bold tracking-tight text-white">Account Settings</h2>
          </div>
          <div className="flex items-center gap-4">
            <button
              type="button"
            ...
            <div className="w-10 h-10 rounded-full bg-[#0040a1] overflow-hidden border-2 border-white/70">
              <img
                alt="User profile"
                  src={profileImage || 'https://lh3.googleusercontent.com/aida-public/AB6AXuAALeV89VJ29XSolHosB2FFM-5zaf5o-SZG94_lbzMDy19d5C9htzzdPQzqf0390OtHReqzpH3Rzl6Y_n-Ej51d0ta38Tfmb0jQjltgzcZ0z71utpRPdfGDhyg5aayR80KmtWVGfXH2lTlXQ_Htu2s6IWJO_dHEPpMxr7596gKDCYrF5DUwEm1H-BY2Hh7kukPYE9TV6vKtbJZ3xYupeXuga_PI70xwBS0XC5J3h1DbFFrOJZPTlBTRi-tP-Aiq2knIeUNNJx9wLGMR'}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div className="lg:col-span-4 space-y-8">
              <div className="bg-white rounded-3xl p-8 flex flex-col items-center text-center">
                <div className="relative mb-6">
                  <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-[#eff4ff]">
                    <img
                      ...
                      src={profileImage || 'https://lh3.googleusercontent.com/aida-public/AB6AXuD4qRnb37ieScYx3E4kaXJg9RdqC9JLrJuzhO1i4pBJo-JGZprr-BIBsY1z3j82Pwr-aNk_yU8UaX0UuwceifA3K9r9TMf1X4pY_7lvKwmia32-TkaNgEY8gBsayMgBJsCTDNfETrGWOfekuXwvxwbxM1pqdHBDDkx2oklBsdy3pH04s057xqIms18VMtX61NWGgYDdzPIVMC64-JGIQEh0jQNEIQ8WcjgeqBYV_CFpckxpT_6UFLILdajhXVEsf8k6O5lvOW6h8atY'}
                      className="w-full h-full object-cover"
                    />
                  </div>
                  <button
                ...
                <h3 className="font-['Manrope'] text-2xl font-extrabold text-[#0d1c2e] tracking-tight">{displayName}</h3>
                <p className="text-[#424654] font-medium mb-4">{displayRole} • Faculty of Computing</p>
                <div className="flex gap-2">
                  <span className="px-3 py-1 bg-[#dae2ff] text-[#001847] text-xs font-bold rounded-full uppercase tracking-wider">Active</span>
                  <span className="px-3 py-1 bg-[#d5e3fc] text-[#424654] text-xs font-bold rounded-full uppercase tracking-wider">Premium Member</span>
                </div>
              </div>

              <div className="bg-gradient-to-br from-[#0040a1] to-[#0056d2] rounded-3xl p-8 text-white relative overflow-hidden">
                <div className="relative z-10">
                  <p className="text-xs font-bold tracking-widest opacity-80 mb-1 uppercase">Dining Perks</p>
                  <h4 className="font-['Manrope'] text-3xl font-black mb-6">{perks.points.toLocaleString()} <span className="text-sm font-medium opacity-80">pts</span></h4>
                  ...
                  <div className="space-y-4">
                    <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm font-bold">{perks.rewardName}</p>
                          <p className="text-[10px] opacity-70">Progress to next reward</p>
                        </div>
                      </div>
                    ...
                    <div className="w-full bg-white/20 h-1.5 rounded-full overflow-hidden">
                      <div className="bg-white h-full" style={{ width: `${perks.progress}%` }} />
                    </div>
                  </div>
                </div>
            ...
            <div className="lg:col-span-8 space-y-8">
              <div className="bg-[#eff4ff] rounded-3xl p-1 md:p-8">
                <div className="bg-white rounded-2xl p-8 shadow-sm">
                  <div className="flex justify-between items-center mb-8">
                    <h4 className="font-['Manrope'] text-xl font-bold text-[#0d1c2e]">Personal Information</h4>
                    <div className="flex items-center gap-3">
                      {isEditingProfile && (
                        <button
                          type="button"
                      ...
                      >
                        <span className="material-symbols-outlined text-sm">{isEditingProfile ? 'save' : 'edit'}</span>
                  ...
                  <form className="grid grid-cols-1 md:grid-cols-2 gap-6" onSubmit={(e) => e.preventDefault()}>
                    <div className="space-y-2">
                      <label className="text-xs font-bold text-[#737785] tracking-wider uppercase">Full Name</label>
                      <input
                    ...
                    <div className="space-y-2">
                      <label className="text-xs font-bold text-[#737785] tracking-wider uppercase">Student ID</label>
                      <input className="w-full bg-[#d5e3fc]/50 border-none rounded-xl px-4 py-3 text-[#424654] font-medium cursor-not-allowed" type="text" value={displayStudentId} readOnly />
                    </div>
                    <div className="space-y-2">
                      <label className="text-xs font-bold text-[#737785] tracking-wider uppercase">Email Address</label>
                      <input className="w-full bg-[#eff4ff] border-none rounded-xl px-4 py-3 focus:ring-2 focus:ring-[#0056d2]/20 text-[#0d1c2e] font-medium transition-all" type="email" value={displayEmail} readOnly />
                    </div>
                  </form>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 gap-8">
                <div className="bg-[#eff4ff] rounded-3xl p-8">
                  <h4 className="font-['Manrope'] text-lg font-bold text-[#0d1c2e] mb-6">Account Settings</h4>
                  <div className="space-y-4">
                    {accountSettings.map((setting) => (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-sm font-semibold text-[#0d1c2e]">{setting.label}</span>
                        </div>

                        {setting.badge ? (
                          <div className="flex items-center gap-2">
                            <span className="text-[10px] text-[#0056d2] font-bold uppercase">{setting.badge}</span>
              ...
              <div className="flex justify-between items-center py-4 border-t border-[#c3c6d6]/40">
                ...
                <p className="text-[10px] text-[#737785] font-medium">Last Login: {lastLogin}</p>
              </div>
            </div>
          </div>
        </div>
