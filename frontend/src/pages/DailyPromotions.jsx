  ...
  return (
    <main className="pt-24 pb-20 px-8 max-w-7xl mx-auto bg-gradient-to-br from-blue-50/50 to-indigo-50/50 min-h-screen">
      ...
      <header className="mb-16">
        <span className="font-label text-xs font-bold tracking-[0.05em] text-primary uppercase mb-2 block">
          Exclusive Offers
        </span>
        <h1 className="font-headline text-5xl font-extrabold text-slate-900 tracking-tight mb-4">
          Daily Promotion
        </h1>
        <p className="text-slate-600 max-w-2xl leading-relaxed text-lg">
          Curated flavors for the academic community. Explore today's special
          offers across SLIIT campuses.
        </p>
      </header>
          ...
          <section className="mb-20">
            ...
            {groupedPromotions["New canteen"]?.length > 0 ? (
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <div className="flex flex-col lg:flex-row h-full">
                    <div className="lg:w-1/2 relative overflow-hidden h-64 lg:h-auto">
                      ...
                      <div className="absolute top-4 left-4">
                        <span className="bg-primary px-3 py-1 text-white text-xs font-bold rounded-lg shadow-lg">
                          FEATURED
                        </span>
                      </div>
                    </div>
                      ...
                      <div>
                        <div className="flex justify-between items-start mb-4">
                          <h3 className="font-headline text-2xl font-bold text-slate-900">
                            {groupedPromotions["New canteen"][0].title}
                          </h3>
                          <span className="text-secondary font-bold text-2xl">
                            Rs.{" "}
                            {
                              groupedPromotions["New canteen"][0]
                                .discountedPrice
                            }
                          </span>
                        </div>
                        <p className="text-slate-600 mb-4 text-sm leading-relaxed">
                          {groupedPromotions["New canteen"][0].description}
                        </p>
                        <div className="flex items-center gap-2 mb-6">
                          <span className="text-slate-400 line-through text-sm">
                            Rs.{" "}
                            {groupedPromotions["New canteen"][0].originalPrice}
                          </span>
                ...
                {/* Secondary Cards */}
                {groupedPromotions["New canteen"]
                  .slice(1, 3)
                  .map((promotion) => (
                    <div
                      key={promotion._id}
                      className="bg-white rounded-[1.5rem] p-6 border border-slate-200 shadow-lg flex flex-col justify-between"
                    >
                      <div>
                        ...
                        <h3 className="font-headline text-lg font-bold mb-2 text-slate-900">
                          {promotion.title}
                        </h3>
              ...
              <div className="flex flex-col items-center justify-center bg-white/50 rounded-[2rem] border-2 border-dashed border-slate-300 p-16 text-center">
                ...
                <h3 className="font-headline text-xl font-bold text-slate-600 mb-2">
          ...
          <section className="mb-20">
            <div className="flex justify-between items-end mb-8">
              <div>
                ...
                <p className="text-slate-600 font-body">
                  Ground floor dining experience
                </p>
              </div>
              <span className="text-primary font-label text-sm font-semibold px-4 py-1 bg-primary/10 rounded-full border border-primary/20">
            ...
            {groupedPromotions["Basement canteen"]?.length > 0 ? (
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <div className="flex flex-col lg:flex-row h-full">
                    ...
                    <div className="lg:w-1/2 p-8 flex flex-col justify-between">
                      <div>
                        <div className="flex justify-between items-start mb-4">
                          <h3 className="font-headline text-2xl font-bold text-slate-900">
                            {groupedPromotions["Basement canteen"][0].title}
                          </h3>
                          <span className="text-secondary font-bold text-2xl">
                            Rs.{" "}
                            {
                              groupedPromotions["Basement canteen"][0]
                                .discountedPrice
                            }
                          </span>
                        </div>
                        <p className="text-slate-600 mb-4 text-sm leading-relaxed">
                          {groupedPromotions["Basement canteen"][0].description}
                        </p>
                        <div className="flex items-center gap-2 mb-6">
                          <span className="text-slate-400 line-through text-sm">
                            Rs.{" "}
                ...
                {/* Secondary Cards */}
                {groupedPromotions["Basement canteen"]
                  .slice(1, 3)
                  .map((promotion) => (
                    <div
                      key={promotion._id}
          ...
          <section className="mb-20">
            <div className="flex justify-between items-end mb-8">
              <div>
                ...
                <p className="text-slate-600 font-body">
                  Premium fusion culinary experiences
                </p>
              </div>
              <span className="text-primary font-label text-sm font-semibold px-4 py-1 bg-primary/10 rounded-full border border-primary/20">
            ...
            {groupedPromotions["Anohana Canteen"]?.length > 0 ? (
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <div className="flex flex-col lg:flex-row h-full">
                    ...
                    <div className="lg:w-1/2 p-8 flex flex-col justify-between">
                      <div>
                        <div className="flex justify-between items-start mb-4">
                          <h3 className="font-headline text-2xl font-bold text-slate-900">
                            {groupedPromotions["Anohana Canteen"][0].title}
                          </h3>
                          <span className="text-secondary font-bold text-2xl">
                            Rs.{" "}
                            {
                              groupedPromotions["Anohana Canteen"][0]
                                .discountedPrice
                            }
                          </span>
                        </div>
                        <p className="text-slate-600 mb-4 text-sm leading-relaxed">
                          {groupedPromotions["Anohana Canteen"][0].description}
                        </p>
                        <div className="flex items-center gap-2 mb-6">
                          <span className="text-slate-400 line-through text-sm">
                            Rs.{" "}
                ...
                {/* Secondary Cards */}
                {groupedPromotions["Anohana Canteen"]
                  .slice(1, 3)
                  .map((promotion) => (
                    <div
                      key={promotion._id}
