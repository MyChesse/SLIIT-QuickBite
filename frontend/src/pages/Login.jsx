      ...
      <section className="hidden md:flex relative items-center justify-center overflow-hidden bg-[#eff4ff] h-screen">
        ...
        <div className="relative z-10 p-16 flex flex-col justify-end h-full w-full">
          <div className="max-w-md">
            <span className="font-headline font-extrabold text-white tracking-widest text-xs uppercase mb-4 block">
              Academic Excellence
            </span>
            ...
            <p className="text-white/80 font-body text-lg">
              Freshly curated meals for the modern scholar, delivered across the
              SLIIT campus with precision and speed.
            </p>
          </div>
        </div>
      </section>
      <section className="flex items-center justify-center p-8 md:p-16 lg:p-24 bg-[#f8f9ff] h-screen">
        <div className="w-full max-w-md">
          <div className="mb-12">
            ...
            <h2 className="font-headline text-3xl font-extrabold text-[#0d1c2e] tracking-tight mb-2">
              Welcome Back
            </h2>
            <p className="text-[#475569] font-body">
              Sign in to your academic dining account
            </p>
          </div>
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <label className="block font-headline font-bold text-xs uppercase tracking-widest text-[#475569] ml-1">
                Email
              </label>
              <div className="relative group">
                <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-[#737785] transition-colors group-focus-within:text-[#0056D2]">
                  mail
                </span>
                <input
                  type="email"
                  ...
                  className={`w-full pl-12 pr-4 py-4 bg-[#eff4ff] rounded-xl border border-[#c3c6d6] focus:outline-none focus:ring-2 focus:ring-[#0056D2]/20 font-body text-[#0d1c2e] placeholder-[#737785] transition-all ${
                    errors.email
                      ...
                      : "border-[#c3c6d6] focus:border-[#0056D2]"
                  }`}
                />
                {errors.email && (
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center px-1">
                <label className="block font-headline font-bold text-xs uppercase tracking-widest text-[#475569]">
                  Password
                </label>
                <button
                  type="button"
            ...
            <div className="flex items-center space-x-3 px-1">
              ...
              />
              <label
                className="text-sm font-body text-[#475569] select-none"
                htmlFor="remember"
              >
          ...
          <div className="mt-24 flex flex-col items-center justify-center border-t border-[#c3c6d6]/10 pt-8">
            <div className="flex items-center gap-6 opacity-30 grayscale contrast-150">
              <span className="font-headline font-black tracking-tighter text-lg">
                SLIIT
              </span>
              <div className="h-4 w-[1px] bg-[#0d1c2e]" />
              <span className="font-headline font-bold text-xs uppercase tracking-[0.2em]">
                Academic Dining Services
              </span>
            </div>
            <p className="text-[10px] text-[#737785] mt-4 font-body uppercase tracking-widest">
