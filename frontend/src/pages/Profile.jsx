        ...
        <aside className="hidden lg:flex w-[250px] flex-col bg-white border-r border-slate-200 px-5 py-6">
          <div className="mb-8">
            <div className="flex items-center gap-3">
              <div className="w-11 h-11 rounded-xl bg-[#0056D2] flex items-center justify-center text-white text-lg font-bold shadow-sm">
                👤
              </div>
              <div>
                <h2 className="text-[24px] leading-none font-bold text-[#0056D2]">
                  Profile
                </h2>
        ...
        <main className="flex-1 px-4 py-6 sm:px-6 lg:px-8">
          <div className="bg-white border border-slate-200 rounded-[24px] p-6 shadow-sm mb-6">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                <h1 className="text-[28px] font-bold text-[#0056D2] tracking-tight">
                  My Profile
                </h1>
              ...
              <button
                ...
                className="h-11 rounded-xl border border-[#FF7A00] bg-[#0056D2] px-5 text-sm font-semibold text-white hover:bg-blue-700 transition"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
            <div className="rounded-[20px] border border-slate-200 bg-white p-5 shadow-sm">
              <div className="flex items-center gap-4">
                <div className="h-16 w-16 rounded-full bg-[#0056D2] flex items-center justify-center text-3xl font-bold text-white">
            ...
            <div className="lg:col-span-2 rounded-[20px] border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="rounded-lg border border-[#475569] bg-[#EEF2FF] p-4">
                  <p className="text-xs uppercase tracking-wider text-[#FF7A00] font-semibold">
                    Full Name
                  </p>
              ...
              {editing && (
                <form onSubmit={handleSubmit} className="mt-6 space-y-4">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full rounded-lg bg-[#FF7A00] px-4 py-3 text-sm font-semibold text-white hover:bg-[#cc6a00] transition disabled:cursor-not-allowed disabled:opacity-70"
                  >
